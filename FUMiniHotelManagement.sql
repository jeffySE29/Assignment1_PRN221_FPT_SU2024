...
GO
INSERT [dbo].[BookingDetail] ([BookingReservationID], [RoomID], [StartDate], [EndDate], [ActualPrice]) VALUES (1, 5, CAST(N'2024-01-01' AS Date), CAST(N'2024-01-02' AS Date), 179.0000)
GO
...
GO
INSERT [dbo].[BookingDetail] ([BookingReservationID], [RoomID], [StartDate], [EndDate], [ActualPrice]) VALUES (2, 4, CAST(N'2024-01-05' AS Date), CAST(N'2024-01-09' AS Date), 219.0000)
GO
SET IDENTITY_INSERT [dbo].[BookingReservation] ON 
GO
INSERT [dbo].[BookingReservation] ([BookingReservationID], [BookingDate], [TotalPrice], [CustomerID], [BookingStatus]) VALUES (1, CAST(N'2023-12-20' AS Date), 378.0000, 1, 1)
GO
INSERT [dbo].[BookingReservation] ([BookingReservationID], [BookingDate], [TotalPrice], [CustomerID], [BookingStatus]) VALUES (2, CAST(N'2023-12-21' AS Date), 1493.0000, 1, 1)
GO
SET IDENTITY_INSERT [dbo].[BookingReservation] OFF
GO
SET IDENTITY_INSERT [dbo].[Customer] ON 
GO
INSERT [dbo].[Customer] ([CustomerID], [CustomerFullName], [Telephone], [EmailAddress], [CustomerBirthday], [CustomerStatus], [Password]) VALUES (1, N'William Shakespeare', N'0903939393', N'WilliamShakespeare@FUMiniHotel.org', CAST(N'1990-02-02' AS Date), 1, N'123@')
GO
INSERT [dbo].[Customer] ([CustomerID], [CustomerFullName], [Telephone], [EmailAddress], [CustomerBirthday], [CustomerStatus], [Password]) VALUES (2, N'Elizabeth Taylor', N'0903939377', N'ElizabethTaylor@FUMiniHotel.org', CAST(N'1991-03-03' AS Date), 1, N'144@')
GO
INSERT [dbo].[Customer] ([CustomerID], [CustomerFullName], [Telephone], [EmailAddress], [CustomerBirthday], [CustomerStatus], [Password]) VALUES (3, N'James Cameron', N'0903946582', N'JamesCameron@FUMiniHotel.org', CAST(N'1992-11-10' AS Date), 1, N'443@')
GO
INSERT [dbo].[Customer] ([CustomerID], [CustomerFullName], [Telephone], [EmailAddress], [CustomerBirthday], [CustomerStatus], [Password]) VALUES (4, N'Charles Dickens', N'0903955633', N'CharlesDickens@FUMiniHotel.org', CAST(N'1991-12-05' AS Date), 1, N'563@')
GO
INSERT [dbo].[Customer] ([CustomerID], [CustomerFullName], [Telephone], [EmailAddress], [CustomerBirthday], [CustomerStatus], [Password]) VALUES (5, N'George Orwell', N'0913933493', N'GeorgeOrwell@FUMiniHotel.org', CAST(N'1993-12-24' AS Date), 1, N'177@')
GO
INSERT [dbo].[Customer] ([CustomerID], [CustomerFullName], [Telephone], [EmailAddress], [CustomerBirthday], [CustomerStatus], [Password]) VALUES (6, N'Victoria Beckham', N'0983246773', N'VictoriaBeckham@FUMiniHotel.org', CAST(N'1990-09-09' AS Date), 1, N'654@')
GO
...
GO
INSERT [dbo].[RoomInformation] ([RoomID], [RoomNumber], [RoomDetailDescription], [RoomMaxCapacity], [RoomTypeID], [RoomStatus], [RoomPricePerDay]) VALUES (4, N'3342', N'Foor 3, Window in the North West ', 5, 5, 1, 219.0000)
GO
INSERT [dbo].[RoomInformation] ([RoomID], [RoomNumber], [RoomDetailDescription], [RoomMaxCapacity], [RoomTypeID], [RoomStatus], [RoomPricePerDay]) VALUES (5, N'4434', N'Floor 4, main window in the South ', 4, 1, 1, 179.0000)
GO
